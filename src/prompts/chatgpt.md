...
- Não utilize a palavra frontend no nome nem qualquer variação delas    

                                                    |
| conteúdo | Você é um roteirista de podcast, e vamos criar um  roteiro de um podcast de tecnologia, focado em frontend cujo o nome é "DevQuest - A Ordem dos Desenvolvedores" e tem foco em frontend,  com o público alvo de iniciantes em frontend
...
- no bloco [FINALIZAÇÃO] substitua por uma despedida cool com o final 'Eu sou a Maria Gabriela e esse foi o CodeQuest dessa semana'
